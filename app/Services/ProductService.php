...
class ProductService extends Service implements ProductRepository
{
    public function findBy($criteria = [], $page, $size) {
        ...
        $products = Product::with('categories:id,name', 'product_price:id,product_id,base_price,margin,final_price', 'outlet:id,name,slug,is_active')->where(Arr::except($criteria, ["name", "category_id"]));
    ...
    public function findOneBy($criteria = []) {
        ...
        $product = Product::with('categories:id,name', 'product_price:id,product_id,base_price,margin,final_price', 'outlet:id,name,slug,is_active')->where(Arr::except($criteria, ["name", "category_id"]));
